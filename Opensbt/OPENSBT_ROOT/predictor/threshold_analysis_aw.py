...
from predictor.agreement_predictor_aw import AgreementPredictorAutoware
...
class ThresholdOptimizer:
    ...
    def __init__(self, predictor: AgreementPredictorAutoware, cv: int = 5):
        """
        Initialize threshold optimizer.
        
        Parameters:
        - predictor: trained AgreementPredictorAutoware instance
...
if __name__ == "__main__":
    ...
    config_path = "./predictor/models/aw/best_model_config_knn.json"

    suffix = "aw"

    print("Loading model...")
    predictor = AgreementPredictorAutoware(
        csv_folder="./predictor/data_aw/data_final/",
        feature_columns=[
           "PedSpeed",
           "EgoSpeed",
           "PedDist"
    ...
    # Visualize
    optimizer.plot_threshold_analysis(save_path=f"./threshold_analysis_gth{goal_threshold}_oth{obstacle_threshold}{suffix}.png")
    optimizer.plot_roc_and_pr_curves(save_path=f"./roc_pr_curves_gth{goal_threshold}_oth{obstacle_threshold}{suffix}.png")
