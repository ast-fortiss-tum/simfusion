...
@dataclass
class ADASMultiSimProblem(Problem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        print(f"Critical Scenario Counts = {len(x) - len(hifi_needed_scenario_counts)} - Non-critical Scenario Counts = {len(hifi_needed_scenario_counts)}")    
        print(f"Carla needs to run for {len(hifi_needed_scenario_counts)} scenarios")

        # check if not critical events occur, escalate to HiFi
        ...
        ##############
        # print("F:       ", out["F"], "\n")
        # print("F_LOFI:  ", out["F_LOFI"], "\n")
        # print("F_HIFI:  ", out["F_HIFI"], "\n")

        # print("CB:      ", out["CB"], "\n")
        # print("CB_LOFI: ", out["CB_LOFI"], "\n")
        # print("CB_HIFI: ", out["CB_HIFI"], "\n")

        # print("SO:      ", out["SO"], "\n")
        # print("SO_LOFI: ", out["SO_LOFI"], "\n")
        # print("SO_HIFI: ", out["SO_HIFI"], "\n")
