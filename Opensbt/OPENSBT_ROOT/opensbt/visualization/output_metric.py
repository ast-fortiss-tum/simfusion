...
def cid_analysis_hitherto(res, save_folder: str, reference_set=None, n_evals_by_axis=None):
...
def calculate_n_crit_distinct(res, 
                             save_folder: str, 
                             bound_min = None, 
                             bound_max = None, 
                             n_cells=N_CELLS,
...
def gd_analysis(res, save_folder: str, input_pf=None, filename='gd', mode='default', critical_only = False):
...
def gd_analysis_hitherto(res, save_folder: str, input_pf=None, filename='gd_global', mode='default'):
...
def igd_analysis(res, save_folder: str, critical_only = False, input_pf=None, filename='igd'):
    # log.info("------ Performing igd analysis ------")
    save_folder_plot =  save_folder + METRIC_PLOTS_FOLDER
    Path(save_folder_plot).mkdir(parents=True, exist_ok=True)
...
def igd_analysis_hitherto(res, save_folder: str, input_pf=None, filename='igd_global'):
    # log.info("------ Performing igd analysis ------")
    save_folder_plot =  save_folder + METRIC_PLOTS_FOLDER
    Path(save_folder_plot).mkdir(parents=True, exist_ok=True)
