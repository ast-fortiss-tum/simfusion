...
class RawData:
    ...
    def evaluate(self, simulator, recording):
        ...
        # result["timestamps"]["ego"] = frames_time_list
        # result["timestamps"]["adversary"] = frames_time_list
...
def set_state_result_actor(log, name, adv_id, result, start, end):
    ...
    for i in range(start, end):
        ...
        adv_acceleration_profile.append(math.sqrt(adv_acceleration.x ** 2 + adv_acceleration.y ** 2 + adv_acceleration.z ** 2))
