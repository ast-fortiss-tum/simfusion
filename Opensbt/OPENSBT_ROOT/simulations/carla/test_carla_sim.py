...
from simulations.config import n_generations, population_size, maximal_execution_time, \
                                rerun_only_critical
...
from simulations.config import xl, xu, \
                                        simulation_variables, scenario_file, \
                                        n_generations, population_size, \
                                        sim_time, sampling_time, critical_function, \
                                        fitness_function, seed                                   
import argparse
...
# Optimization
if algo=="ga":
    optimizer = NsgaIIOptimizer(problem=problem, config=my_config,
...
save_folder = res.write_results(results_folder=RESULTS_FOLDER, 
